...
import cadastro.models.empresa
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('pessoa_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='cadastro.pessoa')),
                ('logo_file', models.ImageField(blank=True, default='imagens/logo.png', null=True, upload_to=cadastro.models.empresa.logo_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pessoa_tel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='telefone', to='cadastro.pessoa')),
            ],
        ),
        migrations.CreateModel(
            name='Site',
            fields=[
                ...
                ('pessoa_site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='site', to='cadastro.pessoa')),
            ],
        ),
        migrations.CreateModel(
            name='Produto',
