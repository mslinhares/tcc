...
from fiscal.models import NotaFiscalSaida, NotaFiscalEntrada, ConfiguracaoNotaFiscal, AutXML, \
    ErrosValidacaoNotaFiscal, RespostaSefazNotaFiscal, NaturezaOperacao, GrupoFiscal, \
    ICMS, ICMSUFDest, ICMSSN, IPI, PIS, COFINS
from tcc.settings import MEDIA_ROOT
from cadastro.models import COD_UF, PessoaJuridica, PessoaFisica, Fornecedor, Cliente, Empresa, Transportadora, Endereco, Telefone, Produto, Unidade
from compras.models import PedidoCompra, ItensCompra
from vendas.models import PedidoVenda, ItensVenda

from vendas.models import Pagamento as PagamentoVenda
